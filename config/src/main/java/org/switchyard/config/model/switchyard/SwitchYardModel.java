...
public interface SwitchYardModel extends NamedModel {
    ...
    public static final String NAMESPACE_1_0 = "urn:switchyard-config:switchyard:1.0";
    public static final String NAMESPACE_1_1 = "urn:switchyard-config:switchyard:1.1";
